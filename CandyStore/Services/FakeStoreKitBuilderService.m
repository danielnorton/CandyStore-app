...
- (void)buildFakeProductDescriptions {
	...
	Product *product = (Product *)[repo itemForId:@"com.brimstead.candystore.orangecandy"];
	...
	product = (Product *)[repo itemForId:@"com.brimstead.candystore.bluecandy"];
	[product setLocalizedPrice:@"$0.99"];
	...
	product = (Product *)[repo itemForId:@"com.brimstead.candystore.exchange"];
	...
	product = (Product *)[repo itemForId:@"com.brimstead.candystore.exchange.7day"];
	[product setLocalizedPrice:@"$0.99"];
	[product setTitle:@"Candy Exchange"];
	
	product = (Product *)[repo itemForId:@"com.brimstead.candystore.exchange.6mo"];
	[product setLocalizedPrice:@"$1.99"];
	[product setTitle:@"Candy Exchange"];
	
	product = (Product *)[repo itemForId:@"com.brimstead.candystore.exchange.1yr"];
...
- (void)buildFakePurchases {
	...
	Product *product = (Product *)[repo itemForId:@"com.brimstead.candystore.bluecandy"];
	Purchase *purchase = [purchaseRepo addOrRetreivePurchaseForProduct:product withTransactionIdentifier:transactionIdentifier];
	[purchase setReceipt:[NSData base64DataFromString:receipt]];
	...
	product = (Product *)[repo itemForId:@"com.brimstead.candystore.orangecandy"];
